...
cp ../snapCterm-if1/sCt-IF1.tap ../Build/snapCterm-IF1.tap
cd ../Build
...
cp ../snapCterm-p/sCt-p.tap ../Build/snapCterm-plus.tap
cd ../Build
...
cp ../snapCterm-p3/sCt-p3.dsk ../Build/snapCterm-plus3.dsk
cd ../Build
